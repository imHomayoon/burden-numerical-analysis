% TAYLOR 2ND Order ALGORITHM - Homayoon
% F     = F(t,y)
...
% FPRIME= Holds the second derivative of Y

syms('F','OK','A','B','ALPHA','N','FLAG', 'ERFLAG','NAME','OUP','H');
syms('T','W','I','x','s', 'y', 'Y', 'FPRIME', 'ERROR');
%-------------------------------------------------------
